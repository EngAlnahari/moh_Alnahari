...
namespace Mntry_Awqaf.Models
{
    ...
    // موديل حدود الأرض
    //    public class EarthBorder
    //    {
    //        public int Id { get; set; }
    //        public int? TanjezOrderId { get; set; }
    //        public string? BorderType { get; set; } // نوع الحد (شمال، جنوب، شرق، غرب، إلخ)
    //        public bool? IsDifferentFromReality { get; set; } // غير مطابق للواقع
    //        public string? DocumentBorder { get; set; } // الحد كما في الوثيقة

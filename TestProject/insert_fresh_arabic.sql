-- حذف البيانات القديمة وإدخال بيانات عربية جديدة
USE Awqaf33;
GO
...
(N'بناء سكني', 1), (N'بناء تجاري', 1),
(N'تركيبات كهربائية', 2), (N'صيانة كهربائية', 2),
(N'تركيب سباكة', 3), (N'صيانة سباكة', 3),
(N'تكييف مركزي', 4), (N'تكييف سبليت', 4),
(N'دهان داخلي', 5), (N'دهان خارجي', 5);
GO
...
-- إدخال الشهادات
INSERT INTO Certificates (CertName, Almgal, CertType, CertYear, UserID)
VALUES 
...
-- إدخال الإشعارات
INSERT INTO Notifications (UserId, ReciveId, UserType, ContractId, Message, Url, IsRead, CreatedAt)
VALUES 
...
-- إدخال الأراضي
INSERT INTO Lands (ParcelNumber, OwnerName, Area, Shape, CreatedAt, CreatedBy, UpdatedBy)
VALUES 
...
SELECT N'تم إدخال البيانات العربية بنجاح!' AS Result;

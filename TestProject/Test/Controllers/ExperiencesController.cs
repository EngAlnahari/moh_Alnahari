...
namespace Test.Controllers
{
    ...
    public class ExperiencesController : ControllerBase
    {
        ...
        public ExperiencesController(DbContextFirst context)
        {
            _context = context;
        }
        ...
        // GET: api/Experience/User/5
        [HttpGet("User/{userId}")]
        public async Task<ActionResult<List<Experience>>> GetExperienceByUser(int userId)
        {
